...
export const navBarHeight: number = 44
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '粉嫩的面包体加入了火龙果果泥，颜值和健康的共存，满满的香浓芝士内陷搭配柔软有嚼劲的软欧包，葡萄干的加缀增添丰富有层次的口感，让你一试喜欢。',
        use_spec: false,
        stock: '100413.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '霸气的外表下包含着软绵甜蜜的榴莲果肉内陷。200度的烘烤热情，以及100分钟以上的制作工艺，这款纯手工软欧包给你大大的甜蜜和满足。',
        use_spec: false,
        stock: '1000215.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '多种草莓元素汇集，打造专属咩咩包的粉红暴击；以草莓果酱特调淡奶油内馅，享受口腔里肆意的爆浆感，表面撒层酸甜草莓粉搭配草莓干颗粒与草莓巧克力薄层，果香萦绕，充满甜美气息。',
        use_spec: false,
        stock: '10102.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '小羊角里加入巧克力味淡奶油内馅，表面撒层馥郁可可粉搭配黑巧爆谷米与黑巧克力薄层，多重巧克力风味，一口即享。',
        use_spec: false,
        stock: '10065.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '香浓抹茶，特调淡奶油内馅，并轻洒在表面一层薄薄的白巧克力上，成就颜值、内涵、口感的三重惊艳，抹茶控必入。',
        use_spec: false,
        stock: '10079.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '奈雪定制茶。选用武夷山金骏眉等三种名优红茶调配而成，有独特的烟熏龙眼木香气，搭配轻盈香滑的芝士奶盖，中和淡淡涩口。',
        use_spec: false,
        stock: '10000077.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '奈雪名优茶。荣获2018年台湾冬茶比赛头等奖。茶山沾染的花香气、低温烘焙的醇甜香，入口回甘。搭配轻盈香滑的咸芝士奶盖，中和淡淡涩口。',
        use_spec: false,
        stock: '10000137.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        content:
          '来自台湾阿里山的乌龙茶，生长于终年云雾缭绕之地，作为正大名茶的特有品种，甘甜带果胶质口感是其独特魅力。花香气清雅，滋味清醇甘甜',
        use_spec: true,
        stock: '9888.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '以现萃咖啡融合茉莉绿茶，加入牛油果、椰子冰淇淋及水晶冻。口感细腻，一口能喝到三重味道，金杯华丽亮相，能量满满。',
        use_spec: false,
        stock: '10000147.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '堂食打包和外卖均提供安心卡，将茶饮制作、面包制作、配餐员以及骑手姓名记录并做好体温测量。做到食品安全可追踪、制作及配送可追踪，请您安心用餐。',
        use_spec: false,
        stock: '999.00',
        type: 4,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '1. 门店伙伴严格执行每小时1次洗手消毒。2. 门店伙伴上岗前进行体温检测。3. 就餐桌椅以及工作台面每小时清洁1次，再用消毒液进行消毒。4. 与食品接触的所有设备、器具、毛巾等严格执行清洁及消毒工作。5. 门店顾客入口处，提供消毒凝胶进行手部消毒。',
        use_spec: false,
        stock: '999.00',
        type: 4,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '草莓、蓝莓、树莓，三种莓果混合搭配，与茉莉毛尖一拍即合，清爽甘醇的茶香搭配浓郁果香，几重滋味在口腔里面碰撞，留下余味。',
        use_spec: false,
        stock: '1001167.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '选用上等茉莉毛尖茶底，纯手工捣碎的百香果，每口都可以喝到满满果肉，浓郁果香中带些酸涩，加入益力多，中和甜味。',
        use_spec: false,
        stock: '998178.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '奈雪人气天后，选用奈雪自有草莓园采摘的新鲜草莓，搭配茉莉毛尖茶底，每一口都有草莓在舌尖跳跃，唇齿留香。',
        use_spec: false,
        stock: '10000653.00',
        type: 1,
        is_label: 0,
    ...
    goods_list: [
      {
        ...
        specs: [],
        content:
          '以霸气芒果打底，加入带椰子果肉的冰淇淋球，冰淇淋加上芒果甜香，每一口都有热带感觉，喝前搅一搅，味道更好。',
        use_spec: false,
        stock: '10001379.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '以霸气草莓打底，加入椰子冰淇淋，搅拌后椰乳慢慢与草莓果肉汁、绿茶单宁、茉莉与椰香融合，口感顺滑、芳香纯美',
        use_spec: false,
        stock: '10001474.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '来自墨西哥的珍稀食材牛油果，制成绵细冰沙口感，与招牌茉莉毛尖结合，加入椰子冰淇淋及水晶冻，丰盛呈现，喝前搅一搅，味道更好。',
        use_spec: false,
        stock: '1001521.00',
        type: 1,
        is_label: 0,
  ...
  },
  {
    ...
    goods_list: [
      ...
      },
      {
        ...
        specs: [],
        content:
          '以鲜牛奶为底，不含茶，加入手工熬煮Q弹黑糖珍珠。全新升级顶部加盖法国总统稀奶油，撒上香脆烤椰条，一勺加一吸管的装备，等你探索味蕾宝藏（本产品的甜度来源于食材本身，没有额外加糖，不能调整糖度）',
        use_spec: false,
        stock: '1000086.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '以鲜牛奶为底，加入升级甄选的芋泥和芋圆，从全新加盖的奶油顶开始享用，还有烤椰条的入口，让饮茶更有FUN。 （本产品的甜度来源于食材本身，没有额外加糖，不能调整糖度）',
        use_spec: false,
        stock: '999422.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '金色山脉茶底加入香甜滑口的奶冻，甘冽的茶香搭配浓郁的奶香，还有嚼劲十足的黑糖珍珠配上Q弹滑爽的奶冻，奶油顶表面撒料的椰条，邀您在更香甜的酥脆中，感受宝藏茶的丰盛。',
        use_spec: false,
        stock: '9902092.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '黑色爆谷米加费列罗，低温研磨而成的黑芝麻酱混合榛子奶，酱香味浓郁(本产品的甜度来源于食材本身，没有额外加糖，不能调整糖度)',
        use_spec: false,
        stock: '99999486.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '顶部酥脆山核桃碎搭配费列罗巧克力，加入榛子奶、旺仔奶冻，口感丰富(本产品的甜度来源于食材本身，没有额外加糖，不能调整糖度)',
        use_spec: false,
        stock: '99998959.00',
        type: 1,
        is_label: 0,
      ...
      },
      {
        ...
        specs: [],
        content:
          '奈雪以维他奶原味豆奶的经典蓝色利乐包装为创意灵感，等比打造了一个plus版的维他奶限量宝藏瓶（附赠PVC袋）',
        use_spec: false,
        stock: '999999574.00',
        type: 1,
        is_label: 0,
